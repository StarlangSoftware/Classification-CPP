 ...
 * eigenvectors.
 *
 * @param eigenvectors {@link vector} of {@link Eigenvector}s whose unnecessary items will be removed.
 */
void Pca::removeUnnecessaryEigenvectors(vector<Eigenvector> eigenvectors) {
